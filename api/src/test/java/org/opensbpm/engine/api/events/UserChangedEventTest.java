...
public class UserChangedEventTest {

    @Test
    public void testSserialize() throws Exception {
        //given
        UserChangedEvent engineEvent = new UserChangedEvent(new UserToken(), Type.CREATE);

        //when
        UserChangedEvent result = deserializeObject(engineEvent);

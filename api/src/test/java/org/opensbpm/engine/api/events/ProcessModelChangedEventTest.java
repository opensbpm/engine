...
public class ProcessModelChangedEventTest {
    ...
    public void testSserialize() throws Exception {
        //given
        ProcessModelChangedEvent engineEvent = new ProcessModelChangedEvent(new ProcessModelInfo(), Type.CREATE);

        //when
        ProcessModelChangedEvent result = deserializeObject(engineEvent);

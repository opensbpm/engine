...
public class ProviderTaskChangedEventTest {

    @Test
    public void testSserialize() throws Exception {
        //given
        ProviderTaskChangedEvent engineEvent = new ProviderTaskChangedEvent(new TaskInfo(), Type.CREATE);

        //when
        ProviderTaskChangedEvent result = deserializeObject(engineEvent);

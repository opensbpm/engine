...
public class ProcessInstanceChangedEventTest {

    @Test
    public void testSserialize() throws Exception {
        //given
        ProcessInstanceChangedEvent engineEvent = new ProcessInstanceChangedEvent(new ProcessInfo(), Type.CREATE);

        //when
        ProcessInstanceChangedEvent result = deserializeObject(engineEvent);

...
public class SimpleAttributeModelIT extends EntityDataTestCase {
    ...
    public void testUniqueConstraintObjectModelAndName() {
        ...
        //when
        SimpleAttributeModel result = entityManager.persistFlushFind(objectModel.addAttributeModel(new SimpleAttributeModel(objectModel, "fieldName", FieldType.STRING)));
